...
<!--             
            ...
            <br> -->
              ...
              <p style="">Name  :<?php echo isset($_SESSION['name']) ? $_SESSION['name'] : ''; ?> </p><br>
              <p style="">Email :<?php echo isset($_SESSION['email']) ? $_SESSION['email'] : ''; ?> </p><br>
              <p style="">Gender:<?php echo isset($_SESSION['gender']) ? $_SESSION['gender'] : ''; ?> </p><br>
