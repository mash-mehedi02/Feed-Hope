...
<script>
      <?php
            ...
            $female=$ro2['count'];
            $male=$row['count'];
            $q3="SELECT count(*) as count FROM food_donations where location=\"dhanmondi\"";
            $res3=mysqli_query($connection, $q3);
            $ro3=mysqli_fetch_assoc($res3);
            $dhanmondi=$ro3['count'];
            $q4="SELECT count(*) as count FROM food_donations where location=\"mirpur1\"";
            $res4=mysqli_query($connection, $q4);
            $ro4=mysqli_fetch_assoc($res4);
            $mirpur1=$ro4['count'];
            $q5="SELECT count(*) as count FROM food_donations where location=\"uttara\"";
...
var xplace=["Dhanmondi","Mirpur 1","Uttara"];
var yplace=[<?php echo json_encode($dhanmondi,JSON_HEX_TAG);?>,<?php echo json_encode($uttara,JSON_HEX_TAG);?>,<?php echo json_encode($mirpur1,JSON_HEX_TAG);?>];
